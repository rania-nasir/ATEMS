...
const Registration = () => {
    ...
    const [taskTitles, setTaskTitles] = useState(['Task 1', 'Task 2', 'Task 3']);
    const [objectives, setObjectives] = useState(['Objective 1', 'Objective 2', 'Objective 3']);
    const [completionDates, setCompletionDates] = useState(['2022-01-01', '2022-02-01', '2022-03-01']);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                throw new Error('Failed to register for thesis two');
            }
        } catch (error) {
