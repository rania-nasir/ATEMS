...
const Aboutsection = () =>{
    return (
        <>
             <div className='grid grid-cols-1 gap-0 m-8 mt-14'>
                        <div className='mt-8'>
                            <p class="mb-4 font-light text-center text-gray-600 dark:text-gray-400 sm:text-xl">About Us</p>
                            <h2 class="mb-8 lg:mb-10 text-4xl tracking-tight font-extrabold text-center text-gray-800 dark:text-white">We're Building Future</h2>
                        </div>
