...
import signincover from '../../Images/logincover.jpg'
                                    ...
                                    <form class="w-full max-w-lg">
                                        ...
                                        <div class="flex flex-wrap -mx-3 mb-6">
                                            ...
                                            <div className="flex px-4 justify-end w-full">
                                                <NavLink onClick={handleForgetPassword} className="text-sm text-teal-800 leading-6 hover:underline hover:text-gray-800">
                                                    Forget Password?
                                                </NavLink>
                                            </div>
                                        </div>
