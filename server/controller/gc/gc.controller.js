...
//         // Check if any required fields are empty in the row
//         const requiredFields = ['rollno', 'namee', 'email', 'gender', 'batch', 'semester', 'program', 'credithours', 'cgpa', 'mobile', 'thesisstatus'];
//         for (const field of requiredFields) {
//           if (!row[field]) {
//             errors.push(`Column '${field}' is empty in row ${i + 2}`);
//           }
//         }
...
//           errors.push(`Invalid gender in row ${i + 2}`);
//         }
//         if (row.semester < 3 || row.semester > 4) {
//           errors.push(`Invalid semester in row ${i + 2}`);
//         }
//         if (row.credithours <= 16) {
//           errors.push(`Invalid credithours in row ${i + 2}`);
//         }
//         if (row.cgpa <= 2 || row.cgpa > 4) {
//           errors.push(`Invalid CGPA in row ${i + 2}`);
//         }
//         if (!/^\d{11}$/.test(row.mobile)) {
//           errors.push(`Invalid mobile number format in row ${i + 2}`);
//         }
//         if (row.thesisstatus !== '1' && row.thesisstatus !== '2') {
//           errors.push(`Invalid thesisstatus in row ${i + 2}`);
//         }
...
//       // Continue with processing the file if all rows pass validation
//       for (const row of data) {
//         const existingStudent = await students.findOne({
//           where: {
//             rollno: row.rollno,
...
//               return res.json({ message: `Validation error: ${errorMessages.join(', ')}` });
//             } else {
//               throw error;
//             }
//           }
...
//       if (!sheet) {
//         return res.json({ error: 'Faculty data must be in the first excel sheet' });
//       }
//       const data = xlsx.utils.sheet_to_json(sheet);
...
//         // Check if any required fields are empty in the row
//         const requiredFields = ['facultyid', 'namee', 'email', 'gender', 'role', 'mobile'];
//         for (const field of requiredFields) {
//           if (!row[field]) {
//             errors.push(`Column '${field}' is empty in row ${i + 2}`);
//           }
